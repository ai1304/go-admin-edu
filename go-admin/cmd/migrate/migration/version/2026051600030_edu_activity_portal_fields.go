...
func init() {
	...
	migration.Migrate.SetVersion(migration.GetFilename(fileName), _2026051600030EduActivityPortalFields)
}

func _2026051600030EduActivityPortalFields(db *gorm.DB, version string) error {
