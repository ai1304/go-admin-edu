...
type EduExpert struct {
	...
	Title         string `json:"title" gorm:"size:128;index;comment:职称"`
	...
	Specialties   string `json:"specialties" gorm:"size:512;index;comment:擅长领域"`
	Introduction  string `json:"introduction" gorm:"type:text;comment:简介"`
	IsRecommended int    `json:"isRecommended" gorm:"default:0;index;comment:是否推荐"`
