...
export function createRecruitCompany(data) {
  return request({ url: `${url}/companies`, method: 'post', data });
}
...
export function createRecruitJob(data) {
  return request({ url: `${url}/jobs`, method: 'post', data });
}
