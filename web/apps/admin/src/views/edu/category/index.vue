  ...
  <div class="container">
    <a-card :bordered="false" class="cardStyle">
      ...
      <a-form :model="queryForm" layout="inline">
        ...
        <a-form-item>
          <a-space>
            <a-button v-has="'edu:category:query'" type="primary" @click="fetchData">查询</a-button>
            <a-button @click="resetQuery">重置</a-button>
            <a-button v-has="'edu:category:add'" type="primary" status="success" @click="openCreate">新增分类</a-button>
          </a-space>
        </a-form-item>
      </a-form>
    </a-card>
    ...
    <a-card :bordered="false" class="cardStyle table-card">
      <a-table :columns="columns" :data="tableData" :pagination="pagination" row-key="id" @page-change="handlePageChange">
        ...
        <template #operations="{ record }">
          <a-space>
            <a-button v-has="'edu:category:edit'" type="text" size="small" @click="openEdit(record)">编辑</a-button>
            <a-button v-has="'edu:category:remove'" type="text" status="danger" size="small" @click="handleDelete(record)">删除</a-button>
          </a-space>
        </template>
      </a-table>
    </a-card>
